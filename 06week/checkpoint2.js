...
const nums = strNums.map((str) => {return parseInt(str,10)});
...
const weatherStates = weather.map((obj) => {
  return obj.weather_state_name;
})
console.log(weatherStates);

//find the id of the object in weather that has a min_temp of 15.915
const idealTempObj = weather.find((obj) => {
  return obj.min_temp === 15.915;
});
const idealTemp = idealTempObj.id;
